...
//         } bg-gradient-to-b from-green-600 to-green-800 text-white shadow-2xl`}
//         style={{ width: "280px" }}
//       >
//         {/* Logo */}
...
//             <p className="text-xs text-green-200">Issue Management</p>
//           </div>
//         </div>
...
//             {/* Staff Avatar */}
//             <div className="avatar">
//               <div className="w-10 h-10 rounded-full ring ring-green-500 ring-offset-2">
//                 <img
//                   src={user?.photo}
//                   alt={user?.name}
//                 />
      ...
      >
        ...
        <div className="h-16 lg:h-20 flex items-center justify-between px-4 border-b border-green-500/30">
          <div className="text-center flex-1">
            <h1 className="text-xl lg:text-2xl font-bold">Staff Panel</h1>
            <p className="text-xs text-green-200">Issue Management</p>
          </div>
