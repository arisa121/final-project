  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">View and update your admin information</p>
      </div>
          ...
          <div className="card bg-gradient-to-br from-blue-600 to-purple-600 text-white shadow-xl">
            <div className="card-body items-center text-center">
              <div className="avatar mb-4">
                <div className="w-32 h-32 rounded-full ring ring-white ring-offset-4 ring-offset-blue-600">
                  <img
                    src={user.photo}
                    alt={user.name}
          ...
          <div className="alert alert-info mt-6">
            ...
            <div>
              ...
              <div className="text-xs">
                For security reasons, email and password changes require
                additional verification. Contact system administrator for
                assistance.
              </div>
            </div>
          </div>
