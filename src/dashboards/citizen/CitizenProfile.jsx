...
//       <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg max-w-full sm:max-w-md mx-auto">
//         {/* Profile Image */}
...
//           <div className="font-bold text-xl sm:text-2xl flex items-center justify-center gap-2">
