...
//         <div>
//           <h2 className="text-xl sm:text-2xl font-bold">My Issues</h2>
...
//       {/* Table */}
//       <div className="overflow-x-auto bg-white shadow rounded-xl -mx-3 sm:mx-0">
...
//           <div
//             className="modal-box max-w-full sm:max-w-lg space-y-3 sm:space-y-4 mx-3"
